	...
	<div class="panel panel-default">
	  <div class="panel-body">
		...
		<div class="col-md-6 col-md-offset-2">
			<b>Kepala UPT Pajak Daerah <br> Wilayah I <br><br><br><br><br><br><br> M.MUNADJAT S.AP <br> NIP.xxxxx</b>
		</div>
		<div class="col-md-4">
			<b>Banjarbaru, {{ $now->format('d M Y') }} <br>	<br> Penanggung Jawab Lapangan <br> Petugas <br><br><br><br><br> MIFTA HIKMAH RIZKY</b>
		</div>
	  </div>
	</div>
