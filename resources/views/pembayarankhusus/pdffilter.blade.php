...
<body>
    ...
    <div id="isi">
        <table align="center" style="border : 1px solid black;
            ...
            <tbody>
                <?php $no = 0;?>
                @foreach($perhitunganKhusus as $data)

                @php
                    $kali=($data['masa_pajak']*$data->jenisreklame['tarif']);

                    $total = 0;
                    $total += ($data['panjang']*$data['lebar']*$data['sisi']*$data['buah']*$data['index_zona_khusus']*$data['index_bahan']*$kali*($data['tarif']/100))
                @endphp
                ...
                <tr>
                    ...
                    <td style="border : 1px solid black;
                                ...
                                padding: 10px;
                                text-align: center;"
                        >973/{{ $data->pendaftaran->id }}-UPTPDWIL1/BPPRD/2019 </td>
                    <td style="border : 1px solid black;
                                border-collapse: collapse;
                                opacity: 0.95;
                                padding: 10px;
                                text-align: center;"
                        >{{ $data->updated_at->format('d F Y') }}</td>
                    <td style="border : 1px solid black;
                                border-collapse: collapse;
                                opacity: 0.95;
                                padding: 10px;
                                text-align: center;"
                        >{{ $data->pendaftaran-> wajibpajak ['nama_wajib_pajak'] }}</td>
                    <td style="border : 1px solid black;
                                border-collapse: collapse;
                                opacity: 0.95;
                                padding: 10px;
                                text-align: center;"
                        >{{ $data->pendaftaran->nama_perusahaan }}</td>
                    <td style="border : 1px solid black;
                                border-collapse: collapse;
                                opacity: 0.95;
                                padding: 10px;
                                text-align: center;"
                        >{{ $data->pendaftaran->teks_reklame}}</td>
                    <td style="border : 1px solid black;
                                border-collapse: collapse;
                                opacity: 0.95;
                                padding: 10px;
                                text-align: center;"
                        >{{ $data->jenisreklame->nama_reklame }}</td>
                    <td style="border : 1px solid black;
                                border-collapse: collapse;
                                opacity: 0.95;
                                padding: 10px;
                                text-align: center;"
                        >{{ $data->pendaftaran->tmt }}</td>
                    <td style="border : 1px solid black;
                                border-collapse: collapse;
                                opacity: 0.95;
                                padding: 10px;
